...
console.log('%c Designed and Developed by Swayam Khandelwal ', 'background-image: linear-gradient(90deg,#8000ff,#6bc5f8); color: white;font-weight:900;font-size:1rem; padding:20px;');
...
//   // Calculate the top offset of the timeline section
//   const timelineSection = document.querySelector(".timeline-section-container"); // Adjust the class accordingly
//   const timelineSectionTop = timelineSection.offsetTop;

//   function updateTimeline() {
//     const scrollY = window.scrollY;

//     // Only start the timeline when the user is close to the timeline section
//     const scrollStart = timelineSectionTop - window.innerHeight / 2;
//     const scrollEnd = timelineSectionTop + window.innerHeight / 2;

//     if (scrollY >= scrollStart && scrollY <= scrollEnd) {
//       const scrollPercentage = ((scrollY - scrollStart) / (scrollEnd - scrollStart)) * 100;

//       // Ensure that the scroll percentage doesn't exceed 100 or go below 0
